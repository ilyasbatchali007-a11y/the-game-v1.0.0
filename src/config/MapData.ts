...
export function generateTestMap(): void {
  // Create a simple 160x160 floor area covering the entire map
  // All tiles are passable floor with green grass texture
  ...
  for (let row = 0; row < MAP_ROWS; row++) {
    for (let col = 0; col < MAP_COLS; col++) {
      ...
      // All tiles are floor - use ID 100 (variation tile)

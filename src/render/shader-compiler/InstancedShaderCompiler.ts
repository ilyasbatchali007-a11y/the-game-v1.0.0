/**
 * Compiles and links WebGL shaders for instanced rendering
 * Handles vertex and fragment shader compilation, program linking, and error reporting
 */
...
export interface UniformLocations {
  ...
  isoAngle: WebGLUniformLocation | null;
  isoScale: WebGLUniformLocation | null;
  cameraOffset: WebGLUniformLocation | null;
  renderMode: WebGLUniformLocation | null;
  entityColor: WebGLUniformLocation | null;
  atlasTileCount: WebGLUniformLocation | null;
  tileSizePixels: WebGLUniformLocation | null;
  worldTileSize: WebGLUniformLocation | null;
  staticRangeStart: WebGLUniformLocation | null;
  staticRangeEnd: WebGLUniformLocation | null;
  variationRangeStart: WebGLUniformLocation | null;
  variationRangeEnd: WebGLUniformLocation | null;
  useAtlas: WebGLUniformLocation | null;
  mapDataTexture: WebGLUniformLocation | null;
  mapDimensions: WebGLUniformLocation | null;
...
export function createShaderProgram(
  ...
  const locations: UniformLocations = {
    ...
    isoAngle: gl.getUniformLocation(program, 'u_isoAngle'),
    isoScale: gl.getUniformLocation(program, 'u_isoScale'),
    cameraOffset: gl.getUniformLocation(program, 'u_cameraOffset'),
    renderMode: gl.getUniformLocation(program, 'u_renderMode'),
    entityColor: gl.getUniformLocation(program, 'u_entityColor'),
    atlasTileCount: gl.getUniformLocation(program, 'u_atlasTileCount'),
    tileSizePixels: gl.getUniformLocation(program, 'u_tileSizePixels'),
    worldTileSize: gl.getUniformLocation(program, 'u_worldTileSize'),
    staticRangeStart: gl.getUniformLocation(program, 'u_staticRangeStart'),
    staticRangeEnd: gl.getUniformLocation(program, 'u_staticRangeEnd'),
    variationRangeStart: gl.getUniformLocation(program, 'u_variationRangeStart'),
    variationRangeEnd: gl.getUniformLocation(program, 'u_variationRangeEnd'),
    useAtlas: gl.getUniformLocation(program, 'u_useAtlas'),
    mapDataTexture: gl.getUniformLocation(program, 'u_mapDataTexture'),
    mapDimensions: gl.getUniformLocation(program, 'u_mapDimensions'),
...
/**
 * Creates the default instanced shader program with built-in vertex and fragment shaders
 */
export function createInstancedShaderProgram(gl: WebGL2RenderingContext): ShaderProgramInfo {
  return createShaderProgram(gl, VS_SOURCE, FS_SOURCE);
}
